...
<aside 
    ...
    <nav class="flex-grow">
        <ul class="space-y-2">
            ...
            <li>
                <a href="{{ route('seller.promotion.index') }}" class="flex items-center p-2 rounded-lg hover:bg-gray-700 {{ request()->routeIs('seller.promotion.*') ? 'bg-gray-900 font-bold' : '' }}" :class="!(isLocked || isHovering) && 'justify-center'">
                    ...
                    <span x-show="isLocked || isHovering" class="ml-3 whitespace-nowrap">Promosi</span>
                </a>
            </li>
            <li>
