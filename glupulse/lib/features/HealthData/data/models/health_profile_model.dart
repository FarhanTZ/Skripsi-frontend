...
class HealthProfileModel extends HealthProfile {
  const HealthProfileModel({
    ...
    super.bmi,
    super.waistCircumferenceCm,
    super.bodyFatPercentage,
    super.hba1cTarget,
    super.lastHba1c,
    super.lastHba1cDate,
    super.targetGlucoseFasting,
    super.targetGlucosePostprandial,
    super.treatmentTypes,
    super.insulinRegimen,
    super.usesCgm,
    super.cgmDevice,
    super.activityLevel,
    super.dailyStepsGoal,
    super.weeklyExerciseGoalMinutes,
    super.preferredActivityTypeIds,
    super.dietaryPattern,
    super.dailyCarbTargetGrams,
    super.dailyCalorieTarget,
    super.dailyProteinTargetGrams,
    super.dailyFatTargetGrams,
    super.mealsPerDay,
    super.snacksPerDay,
    super.foodAllergies,
    super.foodIntolerances,
    super.foodsToAvoid,
    super.culturalCuisines,
    super.dietaryRestrictions,
    super.hasHypertension,
    super.hypertensionMedication,
    super.hasKidneyDisease,
    super.kidneyDiseaseStage,
    super.egfrValue,
    super.hasCardiovascularDisease,
    super.hasNeuropathy,
    super.hasRetinopathy,
    super.hasGastroparesis,
    super.hasHypoglycemiaUnawareness,
    super.otherConditions,
    super.smokingStatus,
    super.smokingYears,
    super.alcoholFrequency,
    super.alcoholDrinksPerWeek,
    super.stressLevel,
    super.typicalSleepHours,
    super.sleepQuality,
    super.isPregnant,
    super.isBreastfeeding,
    super.expectedDueDate,
    super.preferredUnits,
    super.glucoseUnit,
    super.timezone,
    super.languageCode,
    super.enableGlucoseAlerts,
    super.enableMealReminders,
    super.enableActivityReminders,
    super.enableMedicationReminders,
    super.shareDataForResearch,
    super.shareAnonymizedData,
  });
