...
class MealLogModel extends MealLog {
  const MealLogModel({
    super.mealId,
    super.userId,
    required super.mealTimestamp,
    required super.mealTypeId,
    super.description,
    super.totalCalories,
    super.totalCarbsGrams,
    super.totalProteinGrams,
    super.totalFatGrams,
    super.totalFiberGrams,
    super.totalSugarGrams,
    super.tags,
    List<MealItemModel>? super.items,
    super.createdAt,
    super.updatedAt,
  });
