...
import 'dart:math';
import 'package:glupulse/features/presentation/screens/introduction/introduction_screen.dart';
...
class _SplashScreenState extends State<SplashScreen> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    // Navigasi ke halaman perkenalan setelah 3 detik
    Timer(const Duration(seconds: 3), () {
      if (mounted) {
        Navigator.of(context).pushReplacement(
          PageRouteBuilder(
            pageBuilder: (context, animation, secondaryAnimation) => const IntroductionScreen(),
